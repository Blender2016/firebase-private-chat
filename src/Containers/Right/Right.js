    ...
    render(){
        ...
        return(
            <div className={Styles.Right}>
                ...
                <span>To: <span className={Styles.Name}><Avatar src={this.props.otherUserImage} style={{width:'25px',height:'25px'}}/>
                ...
                <Dropdown overlay={menu} >
                    ...
                    <Avatar src={this.props.userImage} style={{width:'25px',height:'25px'}}/> <Icon type="down" />
                    </a>
                </Dropdown>
                </div>
